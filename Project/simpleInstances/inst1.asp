...
% object(product, product#), value(on,pair(shelf_id, quantity))
...
% object(order, order#), value(delivered to pickingStation, station#)
% object(order, order#), value(line, pair(product#, quantity))
% Order#1 정의 : product1 1개, product3 4개를 pickingstation#1에 갖다놔라
